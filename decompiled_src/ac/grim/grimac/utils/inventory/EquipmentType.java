...
public enum EquipmentType {
    ...
    public static EquipmentType getEquipmentSlotForItem(ItemStack itemStack) {
        ...
        if (item == ItemTypes.LEATHER_BOOTS || item == ItemTypes.CHAINMAIL_BOOTS || item == ItemTypes.IRON_BOOTS || item == ItemTypes.DIAMOND_BOOTS || item == ItemTypes.GOLDEN_BOOTS || item == ItemTypes.NETHERITE_BOOTS || item == ItemTypes.COPPER_BOOTS) {
            return FEET;
        }
