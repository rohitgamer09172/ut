 ...
 */
package ac.grim.grimac.shaded.kyori.examination.string;

import ac.grim.grimac.shaded.jetbrains.annotations.NotNull;
import ac.grim.grimac.shaded.jetbrains.annotations.Nullable;
import ac.grim.grimac.shaded.kyori.examination.AbstractExaminer;
import ac.grim.grimac.shaded.kyori.examination.string.StringExaminer;
import ac.grim.grimac.shaded.kyori.examination.string.Strings;
...
extends AbstractExaminer<Stream<String>> {
    ...
    private static Stream<String> enclose(List<String> lines, String open, String close) {
        ...
        return Stream.of(Stream.of(open), MultiLineStringExaminer.indent(lines.stream()), Stream.of(close)).reduce(Stream.empty(), Stream::concat);
    }
