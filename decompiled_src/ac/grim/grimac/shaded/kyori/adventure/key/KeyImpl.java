...
implements Key {
    ...
    KeyImpl(@NotNull String namespace, @NotNull String value) {
        KeyImpl.checkError("namespace", namespace, namespace, value, Key.checkNamespace(namespace), NAMESPACE_PATTERN);
        KeyImpl.checkError("value", value, namespace, value, Key.checkValue(value), VALUE_PATTERN);
