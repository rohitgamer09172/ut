...
public class PaperUtils {
    ...
    public static boolean registerTickEndEvent(Listener listener, Runnable runnable) {
        try {
            ...
            GrimACBukkitLoaderPlugin.LOADER.getServer().getPluginManager().registerEvent(clazz, listener, EventPriority.NORMAL, (l, event) -> runnable.run(), (Plugin)GrimACBukkitLoaderPlugin.LOADER);
            return true;
        }
        catch (Exception e) {
