...
public class Slot {
    ...
    public int getMaxStackSize(ItemStack itemStack) {
        return Math.min(itemStack.getMaxStackSize(), this.getMaxStackSize());
    }
    ...
    public ItemStack safeTake(int p_150648_, int p_150649_, GrimPlayer p_150650_) {
        ...
        optional.ifPresent(p_150655_ -> this.onTake(p_150650_, (ItemStack)p_150655_));
    ...
    public Optional<ItemStack> tryRemove(int p_150642_, int p_150643_, GrimPlayer player) {
        ...
        if (!this.allowModification(player) && p_150643_ < this.getItem().getAmount()) {
            return Optional.empty();
        }
        ItemStack itemstack = this.remove(p_150642_ = Math.min(p_150642_, p_150643_));
